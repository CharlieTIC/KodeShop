                        ...
                        <x-slot name="content">
                            ...
                            <div class="px-4 py-2">
                                ...
                                <p class="text-sm text-center mt-2">
                                    ¿No tiene cuenta? <a href="{{ Route('register') }}" class="text-blue-900 hover:underline">Registrate</a>
                                </p>
                            </div>
                        ...
                        <ul>
                            @foreach ($categorias as $categoria)
                                <li wire:mouseover="$set('categoria_id', {{ $categoria->id }})">
                                    <a href=""
                                        class="flex items-center justify-between px-4 py-4 text-gray-900 hover:bg-blue-600">
                                        {{ $categoria->nombre }}
